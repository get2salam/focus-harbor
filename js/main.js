  ...
  "slug": "focus-harbor",
  "title": "Focus Harbor",
  "tagline": "Guide deep work sessions into a calmer harbor with goals, blocks, and notes.",
  "domainLabel": "sessions",
  "itemLabel": "session",
  "emptyTitle": "No focus sessions yet",
  "emptyBody": "Add a session goal, lock the scope, and note the result.",
  "seedTitle": "Deep work harbor",
  "seedSubtitle": "A small planning surface for better blocks and cleaner finishes.",
  "categories": [
    "Ship",
    "Learn",
    "Admin",
  ...
  "items": [
    {
      ...
      "score": 9,
      "effort": 2,
      "note": "One block, one promise, one call to action."
    },
    {
      "title": "Study transformer attention",
      "category": "Learn",
      "state": "Running",
      "score": 8,
      "effort": 4,
      "note": "Finish with a short self-test to lock the concept in."
    },
    {
      "title": "Close low-value admin loops",
      "category": "Admin",
      "state": "Drifted",
      "score": 5,
      "effort": 2,
      "note": "Bundle tiny tasks into one block instead of scattering them."
    }
  ]
};
