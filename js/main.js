...
const SPEC = {
  "slug": "focus-harbor",
  "title": "Focus Harbor",
  "description": "Guide deep work sessions into a calmer harbor with goals, blocks, and notes.",
  "lede": "Turn deep work into visible sessions with goals, distractions, focus quality, and cleaner session dates.",
  "heroEyebrow": "Deep work workspace",
  "boardTitle": "Focus harbor board",
  "boardSubtitle": "A local-first board for calmer deep work sessions and clearer follow-through.",
  "accent": "Focus improves when the goal, likely distraction, and next session are all visible before the block begins.",
  "itemLabel": "focus session",
  "itemPluralLabel": "Focus sessions",
  "labels": {
    "title": "Session",
    "note": "Session note",
  ...
  "textOne": {
    "label": "Goal",
    "default": "What this session must achieve"
  },
  "textTwo": {
    "label": "Distraction",
    "default": "What will try to break focus"
  },
  "date": {
    "label": "Session date"
  },
  ...
  "defaults": {
    "note": "Capture the setup that makes this block easier to protect."
  },
  "stats": {
    "totalLabel": "Sessions",
    "motionLabel": "Anchored",
    "dueLabel": "Starting soon"
  },
  "insights": {
    "topLabel": "Best next session",
    "dateLabel": "Next focus block",
    "metricLabel": "Highest focus quality"
  },
  "queue": {
    "eyebrow": "Session queue",
    "title": "What deserves a clean block next",
    "empty": "Logged sessions leave the active harbor queue."
  },
  "mix": {
    "eyebrow": "Focus mix",
    "title": "Where your attention is pointed"
  },
  "emptyTitle": "No focus sessions yet",
  "emptyBody": "Add deep work blocks, admin slots, and recovery sessions that need protection.",
  "actions": [
    {
      "id": "anchor",
      "label": "Anchor session",
      "mode": "advance",
      "state": "Anchored",
      "days": 1,
      "fromToday": true,
      "toast": "Anchored the next session."
    },
    {
      "id": "improve-focus",
      "label": "Improve focus",
      ...
      "metricDelta": 1,
      "effortDelta": -1,
      "toast": "Improved the focus setup for this session."
    },
    {
      "id": "log-session",
      "label": "Log session",
      ...
      "days": 0,
      "fromToday": true,
      "toast": "Logged this focus session."
    }
  ],
  "theme": {
    "primary": "#60a5fa",
  ...
  "items": [
    {
      "title": "Qanoon content sprint",
      "category": "Deep work",
      "state": "Anchored",
      "score": 9,
      "effort": 3,
      "metric": 8,
      "textOne": "Write 2 strong landing sections",
      "textTwo": "Telegram interruptions",
      "date": "2026-04-25",
      "note": "Protect the block with browser isolation and a tight output target."
    },
    {
      "title": "Inbox clearance",
      "category": "Admin",
      "state": "Planned",
      "score": 6,
      "effort": 5,
      "metric": 5,
      "textOne": "Clear important threads only",
      "textTwo": "Reply rabbit holes",
      "date": "2026-04-26",
      "note": "Useful, but easy to let it swallow the whole morning."
    },
    {
      "title": "Model research reading",
      "category": "Learning",
      "state": "Drifting",
      "score": 7,
      "effort": 4,
      "metric": 4,
      "textOne": "Extract 3 real notes",
      "textTwo": "Reading without synthesis",
      "date": "2026-04-25",
      "note": "Needs a clearer output target to stay meaningful."
    }
  ]
};
